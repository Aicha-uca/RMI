...
public class MachineForm extends javax.swing.JInternalFrame {
     ...
     public void loadA(){
         if(jComboBox2.getSelectedItem()== null ||jComboBox2.getSelectedItem().toString().isEmpty()) {
           System.out.println("combo");
             ...
             try {
            model.setRowCount(0);
            for(Machine m : dao.findMachinesBySalle((Salle) jComboBox2.getSelectedItem()))
                model.addRow(new Object[]{
                    m.getId(),
                    m.getRef(),
                    m.getMarque(),
    ...
    public MachineForm() {
        initComponents();
        try {
            dao = (IDao<Machine>) Naming.lookup("rmi://localhost:1025/dao");
            salle = (IDao<Salle>) Naming.lookup("rmi://localhost:1025/salle");
    ...
    private void initComponents() {
        ...
        bnAdd.setBackground(new java.awt.Color(0, 153, 204));
        ...
        bnUpdate.setBackground(new java.awt.Color(0, 204, 102));
    ...
    private void bnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bnDeleteActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            System.out.println("sélectionner la ligne à supprimer!");
        }
    } catch (RemoteException ex) {
        ex.printStackTrace();}
